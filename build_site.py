...
COVER_OVERRIDE={"the color monster":"https://covers.openlibrary.org/b/isbn/9780316450010-L.jpg"}
...
:root{--surface:#FCFCF8;--line:#E2E5DA;--soft:#565E4E;--teal:#2F6E58;--tealD:#245648;--coral:#B87343;--amber:#D1965C;--sh:0 1px 2px rgba(43,42,38,.06),0 6px 18px rgba(43,42,38,.07);--shL:0 10px 30px rgba(43,42,38,.14)}
.wrap{max-width:1080px;margin:0 auto;padding:0 18px}
h1,h2,h3{font-family:'Gowun Batang',Georgia,serif;margin:0;line-height:1.15;text-wrap:balance}
a{color:var(--tealD);text-decoration:none}
.top{position:sticky;top:0;z-index:20;background:rgba(228,231,221,.9);backdrop-filter:blur(8px);border-bottom:1px solid var(--line)}
.top .wrap{display:flex;align-items:center;gap:12px;padding:11px 18px}
.brand{font-family:'Gowun Batang',Georgia,serif;font-weight:700}
...
.cv{position:relative;aspect-ratio:3/4;background:#EBEDE3}.cv img{width:100%;height:100%;object-fit:cover;display:block}
...
.cv.noimg .ph{display:flex}.cv .ph .pt{font-family:'Gowun Batang',Georgia,serif;font-weight:700;font-size:.85rem}
...
.bt{font-family:'Gowun Batang',Georgia,serif;font-weight:700;font-size:.95rem;line-height:1.2}
...
.bg.k{background:#fbe0de;color:#a2231d}.bg.g{background:#e7f1f0;color:#245648}.bg.l{background:#fbeee0;color:#8a5a1a}.bg.a{background:#f3e9c9;color:#7a5a00}.bg.n{background:#efe7d6;color:#565E4E}
