...
insert into public.books(theme_key,tier,tier_label,title,author,cover,reason,pop_rank,lib_loans,award,sort) values ('farm',4,'유머·반전','Click, Clack, Moo: Cows That Type','Doreen Cronin','https://covers.openlibrary.org/b/id/5725264-L.jpg','타자기로 요구하는 소들의 유머',58,0,'🏅 칼데콧 아너 2001',3);
...
insert into public.books(theme_key,tier,tier_label,title,author,cover,reason,pop_rank,lib_loans,award,sort) values ('daily-routine',4,'유머·반전','No, David!','David Shannon','https://covers.openlibrary.org/b/id/2269809-L.jpg','말썽꾸러기 데이빗의 "안 돼!" 유머',0,0,'🏅 칼데콧 아너 1999',3);
